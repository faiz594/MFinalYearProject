...
session_start();
include "configure.php"; // ✅ adjust if needed
...
// Default values
$alumni_name = "Alumni";
$alumni_picture = "uploads/default.png"; // fallback image
...
if ($alumni_id) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // ✅ DB already stores "uploads/alumni_123.jpg"
        if (!empty($row['picture'])) {
            $alumni_picture = "/fyp/home/uploads/" . basename($row['picture']);
        } else {
            // Fallback image
            $alumni_picture = "img/default-profile.png";
        }
    }
}
    ...
    <nav class="navbar navbar-dark bg-primary sticky-top p-2 shadow">
        <div class="container-fluid d-flex justify-content-between align-items-center flex-nowrap">
            ...
            <div class="d-flex align-items-center flex-shrink-0">
                ...
                <h4 class="text-white">Alumni Dashboard</h4>
        ...
        <div class="row">
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-primary text-white sidebar collapse sticky-top"
                ...
                <div class="position-sticky pt-3">
                    ...
                    <a href="Alumni-dashboard.php" class="d-flex flex-column align-items-center text-white text-decoration-none">
                        <img src="<?= $alumni_picture ?>" alt="Profile Picture" class="navbar-brand-img">
                        <div class="fw-bold "><?= $alumni_name ?></div>
                    </a>
